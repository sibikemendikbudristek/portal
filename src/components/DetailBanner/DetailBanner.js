...
const DetailBanner = ({bookImg, title, writer, description, attachment, btnType}) => {
    return (
        <section id="DetailBanner">
            <div className="container">
                <div className="row">
                    <div className="col-md-4 col-lg-3 mb-5 mb-md-0">
                        <img className="img-fluid shadow d-block mx-auto" src={bookImg || placeholderImg} alt="" style={{borderRadius: '20px'}} />    
                    </div>
                    <div className="col-md-8 col-lg-9 ps-md-5">
                        ...
                        {btnType === 'pdf' ? <button className="btn btn-light btn-md px-4 mx-2 mx-lg-0 me-lg-2" data-bs-toggle="modal" data-bs-target="#Modal"><i className="fab fa-fw fa-readme" /> Baca</button> : <button className="btn btn-light btn-md px-4 mx-2"><i className="fas fa-fw fa-play" /> Putar</button>}
